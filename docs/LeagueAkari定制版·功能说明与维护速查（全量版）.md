# LeagueAkari 定制版 · 功能说明与维护速查（全量版 2026-09-14）
...
**2026-09-14 好友申请流程测试及中断修复**：工具集 → 好友工具支持自定义时长和间隔、暂停/继续，以及接受后删除。针对撤回中断，增加延迟确认、同期聊天服务错误提示和“仅撤回已发申请”收尾按钮；保持小数秒及 0 秒设置。入口、边界和验证见 §3.16。
