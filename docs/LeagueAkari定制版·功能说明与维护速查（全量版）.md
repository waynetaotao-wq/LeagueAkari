...
| 验证能力     | 2026-09-14 整仓 145 文件 / 1,021 项 Vitest、node/web Typecheck、生产构建通过；真实 Windows Electron 启动、迁移、窗口、代理及在线数据已检查。国服实局与本轮发布包安装验收未完成，见 §3.15   |
...
## 4. 数据源与外部契约（下表含历史契约；复测范围见 §3.13、§3.15）
